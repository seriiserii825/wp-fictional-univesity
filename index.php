		...
		if ( have_posts() ) :
			while ( have_posts() ) :
                ...
                <div class="post-item">
                    ...
                    <div class="meta-box">Posted by <strong><?php the_author_posts_link(); ?></strong> in <em style="color: darkcyan;"><?php the_time( 'd-F-Y' ); ?></em> in <strong><?php echo get_the_category_list( ', ' ); ?></strong></div>
