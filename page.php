...
$header_intro_field = get_field('header_intro')['image'];
$header_intro_img = kama_thumb_src("w=1920 &h=500 &attach_id=$header_intro_field");
?>
...
if ($page_parrent_id || $testArray): ?>
        <div class="page-links">
            <h2 class="page-links__title">
                <a
                    href="<?php echo get_the_permalink($page_parrent_id) ?>"><?php echo get_the_title($page_parrent_id); ?></a>
            </h2>
            <ul class="min-list">
                <?php $childOf = null;?>
