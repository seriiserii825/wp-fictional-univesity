    ...
    <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
            <div class="hero-slider__slide"
                style="background-image: url(<?php echo get_template_directory_uri() . '/assets/images/bus.jpg'; ?>);">
            ...
            <div class="hero-slider__slide"
                style="background-image: url(<?php echo get_template_directory_uri() . '/assets/images/apples.jpg'; ?>);">
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
            ...
            <div class="hero-slider__slide"
                style="background-image: url(<?php echo get_template_directory_uri() . '/assets/images/bread.jpg'; ?>);">
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
